...
<div id="content">
	...
	<div <?php post_class('post-single'); ?> id="post-<?php the_ID(); ?>"><!-- post div -->
		...
		<div class="post-info-top">
			...
			<span id="gotocomments"><a href="#comments"  rel="nofollow" title="Go to comments ?"><?php _e('برو به نظرها'); ?></a></span>
		</div>
		<div class="clear"></div>
		<div class="entry">
			<?php the_content(); ?>
		...
		<div class="add-info">
			<?php if(function_exists('st_related_posts')) { st_related_posts('title=<h3>'._e('مطالب مرتبط').'</h3>'); } ?>
		</div>
