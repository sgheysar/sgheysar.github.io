...
if ( version_compare( $required_php_version, phpversion(), '>' ) )
	wp_die( sprintf( /*WP_I18N_OLD_PHP*/'سرویس‌دهنده‌ی شما نگارش PHP %1$s را اجرا می‌کند در صورتی‌که وردپرس حداقل نیاز به نگارش %2$s و بالاتر از آن دارد.'/*/WP_I18N_OLD_PHP*/, phpversion(), $required_php_version ) );

if ( !extension_loaded('mysql') && !file_exists(ABSPATH . 'wp-content/db.php') )
	wp_die( /*WP_I18N_OLD_MYSQL*/'سرویس MySQL که مورد نیاز وردپرس است بر روی سرویس‌دهنده‌ی شما نصب نیست.'/*/WP_I18N_OLD_MYSQL*/ );
